...
const menuItems: MenuItem[] = [
...

    {
        ...
        // FIX: this was still SUPER_ADMIN_ONLY even though the actual
        // route in App.jsx allows ADMIN_AND_VERTICAL_HEAD_ROLES +
        // TEAM_MEMBER — so everyone else could open the page directly by
