...
const initialTeams: TeamMember[] = [
    {
        id: 1,
        name: "Alice Johnson",
        vertical: "Title Checks (TH)",
        assignTo: "John Developer",
        lastUpdate: "14/01/2026 09:00",
        modifiedBy: "Developer",
    },
    {
        id: 2,
        name: "Bob Smith",
        vertical: "Mortgage Reports (MR)",
        assignTo: "Sarah Manager",
        lastUpdate: "12/01/2026 11:30",
        modifiedBy: "Developer",
    },
    {
        id: 3,
        name: "Carol White",
        vertical: "Search Report (SR)",
        assignTo: "Mike Admin",
        lastUpdate: "10/01/2026 14:00",
        modifiedBy: "Developer",
    },
];
                    ...
                    <tbody>
                        {filtered.map((row, i) => (
                            ...
                            >
                                ...
                                <td style={styles.td}>
                                    <span style={styles.vertBadge}>{row.vertical}</span>
                                </td>
                ...
                <div style={styles.overlay}>
                    <div style={styles.modal}>
                        <h3 style={styles.modalTitle}>
                            {editItem ? "Edit Team Member" : "New Team Member"}
                        </h3>
                        ...
                        <div style={styles.modalField}>
                            ...
                            <select
                                ...
                                value={form.vertical}
                                onChange={(e) =>
                                    setForm((x) => ({ ...x, vertical: e.target.value }))
                                }
                            >
                                {verticals.map((v) => (
                        ...
                        <div style={styles.modalField}>
                            ...
                            <input
                                ...
                                value={form.assignTo}
                                onChange={(e) =>
                                    setForm((x) => ({ ...x, assignTo: e.target.value }))
                                }
                            />
                        </div>
                        <div
