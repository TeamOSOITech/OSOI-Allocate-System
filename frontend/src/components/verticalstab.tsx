...
const initialData: Vertical[] = [
    {
        id: 1,
        name: "Title Checks (TH)",
        time: 120,
        lastUpdate: "14/01/2026 18:37",
        modifiedBy: "Developer",
    },
    {
        id: 2,
        name: "Draft Contract Packs (DCP)",
        time: 30,
        lastUpdate: "03/12/2025 10:13",
        modifiedBy: "Developer",
    },
    {
        id: 3,
        name: "Mortgage Reports (MR)",
        time: 20,
        lastUpdate: "29/12/2025 17:59",
        modifiedBy: "Developer",
    },
    {
        id: 4,
        name: "Search Report (SR)",
        time: 40,
        lastUpdate: "24/10/2025 18:00",
        modifiedBy: "Developer",
    },
    {
        id: 5,
        name: "Remortgage Title Checks (RTC)",
        time: 20,
        lastUpdate: "24/12/2025 10:30",
        modifiedBy: "Developer",
    },
    {
        id: 6,
        name: "Request Redemption Figures (RRF)",
        time: 20,
        lastUpdate: "29/12/2025 17:17",
        modifiedBy: "Developer",
    },
    {
        id: 7,
        name: "Remortgage Completion Statements (RCS)",
        time: 20,
        lastUpdate: "10/12/2025 19:06",
        modifiedBy: "Developer",
    },
    {
        id: 8,
        name: "New File Opening (NFO)",
        time: 30,
        lastUpdate: "13/01/2026 10:32",
        modifiedBy: "Developer",
    },
    {
        id: 9,
        name: "Search Ordering (SO)",
        time: 20,
        lastUpdate: "13/01/2026 10:53",
        modifiedBy: "Developer",
    },
...
export default function VerticalsTab() {
    ...
    const handleDelete = (id: number): void => {
        if (window.confirm("Delete this vertical?")) setData((d) => d.filter((x) => x.id !== id));
    };
                ...
                <div style={styles.overlay}>
                    <div style={isMobile ? styles.modalMobile : styles.modal}>
                        <h3 style={styles.modalTitle}>
                            {editItem ? "Edit Vertical" : "New Vertical"}
                        </h3>
